     ...
     <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            <a href="<c:url value="/"/>"
               class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
                ...
                <span class="fs-4">Blanc</span>
            </a>
            <c:choose>
                <c:when test="${sessionScope.loogedName == null}">
                    <ul class="nav nav-pills">

                        <li class="nav-item"><a href="<c:url value="/join/user-form.jsp"/>"
                                                class="nav-link">회원가입</a>
                        </li>
                        <li class="nav-item"><a href="<c:url value="/join/login.jsp"/>"
                        ...
                        <li class="nav-item"><a href="<c:url value="/reply/board.jsp"/>"
                                                class="nav-link">Reply</a></li>
                        <li class="nav-item"><a href="<c:url value="/reply/write.jsp"/>"
                                                class="nav-link">Reply write</a></li>
                        <li class="nav-item"><a href="<c:url value="/join/withdrawal.jsp"/>"
                                                class="nav-link">회원탈퇴</a>
                        </li>
                    </ul>
                </c:when>
                <c:otherwise>
