...
<form action="front-controller/user/user-remove" method="post">
    <div class="mt-5 mb-5 d-flex justify-content-center">
        <div class="col-6">
            <div class="mb-3">
                <label for="userID" class="form-label">ID</label>
                <input type="text" class="form-control" id="userID_1" placeholder="user id"
                       name="userID"/>
            </div>
        </div>
    </div>
    <div class="row d-flex justify-content-center">
        <div class="col-6">
            <div class="mb-3">
                <label for="userPW" class="form-label">password</label>
                <input type="password" class="form-control" id="userPW_1"
                       placeholder="user password" name="userPW"/>
            </div>
        </div>
    </div>
    <div class="mt-5 mb-5 d-flex justify-content-center">
        <div class="col-6">
            <button type="submit" class="btn btn-primary" id="btnSubmit1">회원탈퇴</button>
        </div>
    </div>
</form>
