...
<h2>회원가입</h2>
<hr>
<form id="createMember" action="front-controller/join-save" method="post">
...
<br>
<h2>회원삭제</h2>
<form id="deleteMember" action="front-controller/join-delete" method="post">
    <div><input type="text" name="userID" placeholder="ID" required></div>
    <div><input type="password" name="userPW" placeholder="Password" required></div>
...
<br>
<h2>모든 회원 조회</h2>
<form id="selectAllMember" action="front-controller/member-list" method="post">
